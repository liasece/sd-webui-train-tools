...
for mod in [ 'library' ]:
    if sys.modules.get(mod):
        ...
        del sys.modules[mod]
sys.path.insert(0,os.path.abspath(os.path.join(os.path.dirname(__file__), "sd_scripts")))

import liasece_sd_webui_train_tools.sd_scripts.library.train_util as util
import liasece_sd_webui_train_tools.sd_scripts.library.config_util as config_util
