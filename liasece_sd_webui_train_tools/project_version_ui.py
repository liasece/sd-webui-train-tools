...
def on_ui_change_project_click(to_project: str):
    ...
    ]+get_project_version_dataset_box_update(to_project, default_project_version)+gr_update_checkpoint_list(to_project, default_project_version)+load_gr_update(to_project, default_project_version)
...
def ui_refresh_project(now_project: str, now_project_version: str):
    ...
    ]+get_project_version_dataset_box_update(to_project, to_project_version)+gr_update_checkpoint_list(to_project, to_project_version)+load_gr_update(to_project, to_project_version)
...
def on_ui_create_project_click(new_project_name: str):
    ...
    ]+get_project_version_dataset_box_update(new_project_name, "")+gr_update_checkpoint_list(new_project_name, "")+load_gr_update(new_project_name, "")
...
def on_ui_change_project_version_click(project: str, to_version: str):
    ...
    ]+get_project_version_dataset_box_update(project, to_version)+gr_update_checkpoint_list(project, to_version)+load_gr_update(project, to_version)
...
def ui_refresh_version(project: str, now_version: str):
    ...
    ]+get_project_version_dataset_box_update(project, to_project_version)+gr_update_checkpoint_list(project, to_project_version)+load_gr_update(project, to_project_version)
...
def on_ui_create_project_version_click(project: str, new_version_name: str):
    ...
    return [
        ...
        gr.Row.update(visible=True),
    ]+gr_update_checkpoint_list(project, new_version_name)+load_gr_update(project, new_version_name)
